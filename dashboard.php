                    ...
                    <tbody>
                        <?php foreach ($row as $key => $user) { ?>
                            <tr>
                                ...
                                <?php
                                if ($user['type'] === 0) {
                                    if ($user['username'] == 'crescent') { ?>
                                       <td><a href="#" name="type" class="btn badge rounded-pill btn-danger" onclick="alert('This is Super Admin')">Super Admin</a></td>
                                    <?php } else {
                                    ...
                                    echo '<td><a href="#" name="type" class="btn badge rounded-pill btn-secondary">User</a></td>';
                                }
                                if ($user['username'] == 'crescent') { ?>
                                    <td><a href="#" class="btn btn-sm btn-danger" onclick="alert('You can not reset super admin password')">Reset</a></td>
                                <?php } else { ?>
